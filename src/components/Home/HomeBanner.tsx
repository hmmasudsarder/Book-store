      ...
      <div className="flex flex-col lg:flex-row items-center gap-5">
        ...
        <div className="flex lg:flex-col gap-3 md:gap-6 lg:gap-3">
          <div className="h-[170px]">
            <img src={bg1} alt=""  className="w-full md:w-[360px] h-full object-cover rounded-xl transition-all duration-300 ease-in-out transform scale-100 hover:scale-105"/>
          </div>
          <div className="h-[170px]">
